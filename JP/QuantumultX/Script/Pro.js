...
const config ={
    API:'https://raw.githubusercontent.com/MapleRen/MapleStoryM-language/master/JP/xml/mod_pro.xml',
    files:['data.bin.lan.jpn.tbl', 'data.table.unity3d','data.language_jpn.unity3d'],
    prefix:'msm_jpn_needRedirect',
    title:'进阶汉化'
}
